...
import image from "../../../../public/images/banner-logo.svg";
          ...
          <div className="w-max mx-auto mt-4">
            ...
            >
              ...
              <div className="flex items-center justify-center gap-1 md:gap-8">
                ...
                <div className="h-8 w-px bg-ui-gray" />
            ...
            <div className="bg-[#FFF7DF] p-4 md:px-12 py-6 rounded-b-lg">
              <Button className="w-[90%] mx-auto">Login To EatSure</Button>
            </div>

            <button className="w-full mt-4 px-4 py-3 rounded-t-md flex justify-between items-center text-xs text-white bg-primary">
